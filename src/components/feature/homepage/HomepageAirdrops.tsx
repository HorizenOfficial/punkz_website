        ...
        <section {...props} id="airdrops">
            <SectionContainer>
                <div className="grid grid-cols-1 lg:grid-cols-[35fr,65fr]">
                    <div className="bg-secondary-dark py-10 lg:pt-[88px] lg:pr-[72px]">
                        <ContentContainer className="lg:!pr-0 lg:!mr-0 lg:text-right">
                            <div className="grid justify-items-start grid-cols-1 md:justify-items-start md:grid-cols-2 md:gap-x-3 md:items-center lg:grid-cols-1 item">
                                ...
                                <Body1 className="!text-secondary text-left text-lg md:!max-w-[320px] md:text-[22px] md:leading-[35px] md:text-left lg:text-right lg:mt-[40px] lg:ml-auto">
                    ...
                    <div className="bg-primary-light pt-10 pb-12 lg:pt-[88px] lg:pl-[45px] lg:pb-[100px]">
