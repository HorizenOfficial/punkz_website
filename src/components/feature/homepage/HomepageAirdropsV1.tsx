...
> = (props) => {
    const paddingsLeft = "px-6 md:px-12 lg:pl-8"
    const paddingsRight = "px-6 md:px-12 lg:pr-8"
            ...
            <div className="relative lg:h-[440px] bg-secondary-dark grid grid-cols-1 lg:grid-cols-[35fr,65fr]">
                ...
                >
                    <Body1 className="font-bold">
                        TZNY and TCAKE holders as of July 5th 00:00am EST will
                        get a Punkz Token airdrop.
                    </Body1>
            ...
            <div className="relative lg:h-[440px] bg-secondary-dark grid grid-cols-1 lg:grid-cols-[65fr,35fr]">
                ...
                >
                    ...
                    <Body1>
                        ...
                        pre-approved and meets other set requirements to receive
                        Punkz airdrops.
                    </Body1>
                    <Body1 className="italic text-gray">
                        Details about how to get on to the Punkz Droplist are
                        coming soon
                    </Body1>
                </BigBox>
                <SmallBox
